...
function totalCost() {
    ...
    totalPrice.innerText = stringToNumber('normal-price') + stringToNumber('memory-price') + stringToNumber('storage-price') + stringToNumber("delivery-price");
    totalMain.innerText = stringToNumber('normal-price') + stringToNumber('memory-price') + stringToNumber('storage-price') + stringToNumber("delivery-price");
}
// MEmory 
